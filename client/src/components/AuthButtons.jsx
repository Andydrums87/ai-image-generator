    ...
    return (
      <>
        {signInButtons.map((btn, i) => (
            ...
            type="submit" 
            className={`${i === selectedBtn ? "opacity-40 bg-violet-100 cursor-not-allowed" : "bg-violet-100"} flex text-xs items-center mb-5 max-h-[55px] aria-checked:bg-sky-700 justify-center gap-5 text-white-100 w-[100%] px-20 rounded-lg py-4`}>
            <img 
